...
- Classic run-and-jump platforming across Himalayan-themed levels
- Original characters, art, music, and level design rooted in Nepali culture
- Power-ups inspired by Nepali staples — momo for health, chiya for speed
- Boss encounters drawn from Himalayan folklore (yeti, anyone?)

## Getting Started

The game is in early development. Build and run instructions will land here once the first playable prototype exists.

## Contributing

Contributions are welcome. By submitting a contribution, you agree it is licensed under the Apache License 2.0 (see [LICENSE](LICENSE)).
